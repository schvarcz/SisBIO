...
$form->field($model, 'idGenero')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\Genero::find()->all(),'idGenero','label'),
    ['prompt'=>'Choose...']
); ?>
			<?= // generated by schmunk42\giiant\crud\providers\RelationProvider::activeField
$form->field($model, 'idTipo_Organismo')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\TipoOrganismo::find()->all(),'idTipoOrganismo','label'),
    ['prompt'=>'Choose...']
); ?>
