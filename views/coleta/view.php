...
// generated by schmunk42\giiant\crud\providers\RelationProvider::attributeFormat
    ...
    <p class='pull-right'>
        <?=
        \yii\helpers\Html::a(
                '<span class="glyphicon glyphicon-list"></span> Listar todos Coleta Items', ['coleta-item/index'], ['class' => 'btn text-muted btn-xs']
        )
        ?>
        <?=
        \yii\helpers\Html::a(
                '<span class="glyphicon glyphicon-plus"></span> Novo Coleta Item', ['coleta-item/create', 'ColetaItem' => ['idColeta' => $model->idColeta]], ['class' => 'btn btn-success btn-xs']
        )
        ?>
    </p><div class='clearfix'></div>
...
// generated by schmunk42\giiant\crud\providers\RelationProvider::columnFormat
    ...
    <p class='pull-right'>
        <?=
        \yii\helpers\Html::a(
                '<span class="glyphicon glyphicon-list"></span> Listar todos Id Pesquisadors', ['pesquisador/index'], ['class' => 'btn text-muted btn-xs']
        )
        ?>
        <?=
        \yii\helpers\Html::a(
                '<span class="glyphicon glyphicon-plus"></span> Novo Id Pesquisador', ['pesquisador/create', 'IdPesquisador' => ['idPesquisador' => $model->idColeta]], ['class' => 'btn btn-success btn-xs']
        )
        ?>
        <?=
        \yii\helpers\Html::a(
                '<span class="glyphicon glyphicon-link"></span> Attach Id Pesquisador', ['coleta-has-pesquisador/create', 'ColetaHasPesquisador' => ['idColeta' => $model->idColeta]], ['class' => 'btn btn-info btn-xs']
        )
        ?>
    </p><div class='clearfix'></div>
