...
$this->title = 'Filo View ' . $model->idFilo . '';
...
<div class="filo-view">
    ...
    <p class='pull-left'>
        <?= Html::a('<span class="glyphicon glyphicon-pencil"></span> Edit', ['update', 'idFilo' => $model->idFilo],
        ['class' => 'btn btn-info']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-plus"></span> New Filo', ['create'], ['class' => 'btn
        btn-success']) ?>
    </p>
    ...
    <?php echo Html::a('<span class="glyphicon glyphicon-trash"></span> Delete', ['delete', 'idFilo' => $model->idFilo],
    [
...
<p class='pull-right'>
  <?= \yii\helpers\Html::a(
            '<span class="glyphicon glyphicon-list"></span> List All Ordems',
            ['ordem/index'],
            ['class'=>'btn text-muted btn-xs']
        ) ?>
  <?= \yii\helpers\Html::a(
            '<span class="glyphicon glyphicon-plus"></span> New Ordem',
            ['ordem/create', 'Ordem'=>['idFilo'=>$model->idFilo]],
