    ...
    <div class="">
        ...
        <p>
            ...
            $form->field($model, 'idTipoDado')->dropDownList(
                    \yii\helpers\ArrayHelper::map(app\models\TipoDado::find()->all(), 'idTipoDado', 'label'), ['prompt' => 'Choose...']
            );
            ?>
            <?=
            // generated by schmunk42\giiant\crud\providers\RelationProvider::activeField
            $form->field($model, 'idTipoDescritor')->dropDownList(
                    \yii\helpers\ArrayHelper::map(app\models\TipoDescritor::find()->all(), 'idTipoDescritor', 'label'), ['prompt' => 'Choose...']
            );
            ?>
