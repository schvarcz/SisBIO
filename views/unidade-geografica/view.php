...
<div class="unidade-geografica-view">
    ...
    <p class='pull-right'>
        ...
        if(\Yii::$app->user->can("adminColeta",["projeto" => $model->idProjeto0]))
        {
    ...
    \yii\grid\GridView::widget([
        ...
        'columns' => [ 'idColeta',
            ...
            [
                ...
                'template' => '{view}'.((\Yii::$app->user->can("adminColeta",["projeto" => $model->idProjeto0]))?' {update} {delete}':''),
    ...
    <p class='pull-right'>
        ...
        <?=
        \yii\helpers\Html::a(
                '<span class="glyphicon glyphicon-plus"></span> Nova Unidade Geográfica Filha', ['unidade-geografica/create', 'UnidadeGeografica' => ['idUnidadeGeograficaPai' => $model->idUnidadeGeografica]], ['class' => 'btn btn-success btn-xs']
        )
        ?>
    </p><div class='clearfix'></div>
                    ...
                    \yii\bootstrap\Tabs::widget(
                            [
                                ...
                                'items' => [ [
                                        ...
                                        'label' => '<small><span class="glyphicon glyphicon-paperclip"></span> Unidades Geográficas Filhas</small>',
